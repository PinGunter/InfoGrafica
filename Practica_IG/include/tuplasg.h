...
template <class T, unsigned n>
inline TuplaG<T, n>::TuplaG()
{
}

// constructor usando un array C++
template <class T, unsigned n>
inline TuplaG<T, n>::TuplaG(const T *org)
{
...
template <class T, unsigned n>
inline TuplaG<T, n>::operator const T *() const
{
   return coo;
}
...
// obtener longitud al cuadrado
template <class T, unsigned n>
inline T TuplaG<T, n>::lengthSq() const
{
...
template <class T>
inline TuplaG2<T>::TuplaG2(const TuplaG<T, 2> &ini)
{
   (*this)[0] = ini(0);
   (*this)[1] = ini(1);
}
...
template <class T>
inline void TuplaG2<T>::operator=(const TuplaG<T, 2> &der)
{
   (*this)[0] = der(0);
   (*this)[1] = der(1);
}
...
template <class T>
inline TuplaG2<T>::TuplaG2(const T &c0, const T &c1)
{
   (*this)[0] = c0;
   (*this)[1] = c1;
}
...
template <class T>
inline TuplaG3<T>::TuplaG3(const TuplaG<T, 3> &ini)
{
   (*this)[0] = ini(0);
   (*this)[1] = ini(1);
   (*this)[2] = ini(2);
...
template <class T>
inline void TuplaG3<T>::operator=(const TuplaG<T, 3> &der)
{
   (*this)[0] = der(0);
   (*this)[1] = der(1);
   (*this)[2] = der(2);
...
template <class T>
inline void TuplaG3<T>::operator=(const TuplaG<T, 4> &der)
{
   (*this)[0] = der(0);
   (*this)[1] = der(1);
   (*this)[2] = der(2);
...
template <class T>
inline TuplaG4<T>::TuplaG4(const TuplaG<T, 4> &ini)
{
   (*this)[0] = ini(0);
   (*this)[1] = ini(1);
   (*this)[2] = ini(2);
...
template <class T>
inline void TuplaG4<T>::operator=(const TuplaG<T, 4> &der)
{
   (*this)[0] = der(0);
   (*this)[1] = der(1);
   (*this)[2] = der(2);
